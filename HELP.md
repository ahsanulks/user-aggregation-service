...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.3.0-M1/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm -p 8080:8080 moneyforward:0.0.1-SNAPSHOT
```
